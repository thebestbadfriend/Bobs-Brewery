...
--
-- Name: contacts_addresses; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER SEQUENCE public.fax_numbers_id_seq OWNER TO postgres;
...
--
-- Data for Name: contacts_addresses; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.contacts_addresses (contact_id, address_id, last_verified) FROM stdin;
\.
...
SELECT pg_catalog.setval('public.fax_numbers_id_seq', 1, false);
...
--
-- Name: contacts_addresses contacts_addresses_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contacts_addresses
    ADD CONSTRAINT contacts_addresses_pkey PRIMARY KEY (contact_id, address_id);
...
--
-- Name: contacts_addresses contacts_addresses_address_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contacts_addresses
    ADD CONSTRAINT contacts_addresses_address_id_fkey FOREIGN KEY (address_id) REFERENCES public.addresses(id);


--
-- Name: contacts_addresses contacts_addresses_contact_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.contacts_addresses
    ADD CONSTRAINT contacts_addresses_contact_id_fkey FOREIGN KEY (contact_id) REFERENCES public.contacts(contact_id);
